...
here may import a consuming host application or a concrete provider client.
Bundled adapters (mail, notify, calendar) register into the adapter registry at
a host composition layer that lives outside this package.
"""
